...
input.question("1.First_Name   2.Last_Name  3.Email  4.PhoneNo  5.Password_Rule1   6.Password_Rule2 \n", function (option) {
        ...
        case "3":
            ...
            case "4":
                ...
                case "5":
                    ...
                    case "6":
                        input.question("Enter password with atleast 1 upper case char : \n", function (password) {
